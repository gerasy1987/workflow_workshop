...
- [github.com/gerasy1987/dotfiles](https://github.com/gerasy1987/dotfiles) contains links to materials we will go over
...
:::columns
:::{.column style="margin-top: 5em; width:50%;"}
```{mermaid}
%%{init: {
  'theme': 'base',
...
- Don't stress about memorizing everything; focus on understanding the basics.
- Use resources and tools to help you when you need them.
:::
...
- Installation instructions at <https://quarto.org/docs/get-started/> (or just Google) 